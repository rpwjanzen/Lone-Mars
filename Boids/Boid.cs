...
namespace Lone_Mars {
    class Boid {
        ...
        protected FInt VisionRangeSquared = new FInt(50.0 * 50.0);
        protected FInt AlignmentWeight = new FInt(1.0);
        protected FInt CohesionWeight = new FInt(0.0);
        protected FInt SeperationWeight = new FInt(0.25);
        protected FInt Momentum = new FInt(8.0);
        protected FInt RandomWeight = new FInt(0.0);
        protected FInt MaxVelocity;

        protected FInt MinX = new FInt(-(1440.0 / 2.0));
        protected FInt MaxX = new FInt((1440.0 / 2.0));
        protected FInt MinY = new FInt(-(900.0 / 2.0));
        protected FInt MaxY = new FInt((900.0 / 2.0));
